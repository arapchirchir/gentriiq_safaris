<x-layouts.admin title="Dashboard Overview">
    ...
    <div class="space-y-8">
        <!-- Welcome Banner -->
        <div class="flex flex-col justify-between gap-4 rounded-sm border border-black/10 bg-white p-6 shadow-xs sm:flex-row sm:items-center dark:border-white/10 dark:bg-[#24140E]">
            <div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <!-- Total Inquiries -->
            <div class="rounded-sm border border-black/10 bg-white p-5 shadow-xs dark:border-white/10 dark:bg-[#24140E]">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold uppercase tracking-wider text-[#6E635C] dark:text-[#FAF6F0]/60">Total Proposals</span>
            ...
            <div class="rounded-sm border border-[#D96B27]/30 bg-white p-5 shadow-xs dark:border-[#D96B27]/30 dark:bg-[#24140E]">
                <div class="flex items-center justify-between">
            ...
            <div class="rounded-sm border border-black/10 bg-white p-5 shadow-xs dark:border-white/10 dark:bg-[#24140E]">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold uppercase tracking-wider text-[#6E635C] dark:text-[#FAF6F0]/60">Published Tours</span>
                    <span class="rounded-full bg-[#D96B27]/10 p-2 text-[#D96B27]">
                        <svg class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mt-4 flex items-baseline justify-between">
                    ...
                    <span class="text-xs font-semibold text-[#6E635C] dark:text-[#FAF6F0]/60">Of {{ $metrics['total_tours'] }} Total</span>
                </div>
            </div>
            ...
            <div class="rounded-sm border border-black/10 bg-white p-5 shadow-xs dark:border-white/10 dark:bg-[#24140E]">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold uppercase tracking-wider text-[#6E635C] dark:text-[#FAF6F0]/60">Destinations</span>
                    <span class="rounded-full bg-[#D96B27]/10 p-2 text-[#D96B27]">
                        <svg class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mt-4 flex items-baseline justify-between">
                    <p class="text-3xl font-black text-[#211915] dark:text-white">{{ $metrics['total_destinations'] }}</p>
        ...
        <div class="rounded-sm border border-black/10 bg-white shadow-xs dark:border-white/10 dark:bg-[#24140E]">
            <div class="flex flex-wrap items-center justify-between gap-4 border-b border-black/10 p-5 dark:border-white/10">
                <div>
                    <h3 class="text-base font-bold text-[#211915] dark:text-white">Recent Safari Proposals</h3>
                    <p class="text-xs text-[#6E635C] dark:text-[#FAF6F0]/70">Latest requests submitted through the online trip planner.</p>
                </div>
                        ...
                        @forelse ($recentInquiries as $inquiry)
                            <tr class="hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
                                ...
                                <td class="py-3.5 px-4">
                                    ...
                                    <div class="text-[11px] text-[#6E635C] dark:text-[#FAF6F0]/60">{{ $inquiry->email }}</div>
                                </td>
                                <td class="py-3.5 px-4">
