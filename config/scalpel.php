...
return [
    ...
    */
    ...
    'content_scan_excluded_paths' => [
        'vendor',
        'bootstrap/cache',
        // Blade templates contain Alpine/JS template literals that the regex-based backtick
        // check reads as PHP shell_exec. They remain protected by BaselineDiffScanner hashes.
        'resources/views',
        // Compiled Blade output: regenerated by view:cache on every deploy, and Laravel's
        // component prop code ($$__key) trips the variable-variables check.
        'storage/framework/views',
    ],
